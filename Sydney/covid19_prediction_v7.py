...
def plot_rt(result, ax):
    ...
    extended = pd.date_range(start=pd.Timestamp('2020-02-01'),
    ...
    ax.margins(0)
    ax.set_ylim(0.0, 5.0)
    ax.set_xlim(pd.Timestamp('2020-02-01'), result.index.get_level_values('notification_date')[-1] + pd.Timedelta(days=1))
    fig.set_facecolor('w')
